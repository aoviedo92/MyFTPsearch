...
(function () {
    angular.module('app')
        .controller('TitlebarController', ["$scope", "$interval", titleBarController]);
})();
function titleBarController($scope, $interval){
    var remote = require('remote');

    var maximizeMode = "maximize";
    maximizeStyle();

    function maximizeStyle(){
        $scope.maximizeStyle = {'background-image': 'url(assets/img/titlebar/' + maximizeMode + '.png)'};
